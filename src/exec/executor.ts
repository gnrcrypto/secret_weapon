...
export class Executor {
  ...
  private isSimulationMode(): boolean {
    return Config.execution.mode === 'simulate'; // Fixed: 'simulate' instead of 'simulation'
  }
  ...
  async executeAtomicSwap(
    ...
    dryRun: boolean = this.isSimulationMode()
    ...
    try {
      ...
      const swapTx = await txBuilder.buildAtomicSwapTx(
        ...
        undefined,
        opportunity.executionPriority as 'low' | 'standard' | 'high'
      );
