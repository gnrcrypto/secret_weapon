...
export class MetricsService {
  ...
  // Counters
  private opportunitiesFound: Counter;
  private tradesExecuted: Counter;
  private tradesSuccessful: Counter;
  private tradesFailed: Counter;
  private profitTotal: Counter;
  private lossTotal: Counter;
  private gasSpent: Counter;
  private errorsTotal: Counter;
  
  // Gauges
  private currentPrice: Gauge;
  private walletBalance: Gauge;
  private exposureByToken: Gauge;
  private circuitBreakerStatus: Gauge;
  private blockLag: Gauge;
  private pendingTransactions: Gauge;
  private riskScore: Gauge;
  
  // Histograms
  private tradeProfitHistogram: Histogram;
  private executionTimeHistogram: Histogram;
  private gasUsedHistogram: Histogram;
  private priceImpactHistogram: Histogram;
  private simulationTimeHistogram: Histogram;
