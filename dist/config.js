...
exports.Config = {
    ...
    execution: {
        mode: (process.env.EXECUTION_MODE || 'simulate'),
    ...
    flashLoans: {
        ...
        defaultProvider: (process.env.DEFAULT_FLASH_LOAN_PROVIDER || 'aave'),
...
const schema = joi_1.default.object({
    network: joi_1.default.object().required(),
    wallet: joi_1.default.object().required(),
    execution: joi_1.default.object().required(),
}).unknown(true);
const { error } = schema.validate(exports.Config);
if (error) {
