...
exports.POLYGON_ADDRESSES = exports.interfaces = exports.CHAINLINK_ORACLE_ABI = exports.WMATIC_ABI = exports.MULTICALL_ABI = exports.BALANCER_VAULT_ABI = exports.AAVE_LENDING_POOL_ABI = exports.CURVE_POOL_ABI = exports.CURVE_ROUTER_ABI = exports.UNISWAP_V3_ROUTER_ABI = exports.UNISWAP_V2_FACTORY_ABI = exports.UNISWAP_V2_PAIR_ABI = exports.UNISWAP_V2_ROUTER_ABI = exports.ERC20_ABI = void 0;
...
exports.interfaces = {
    ...
    CurveRouter: new ethers_1.Interface(exports.CURVE_ROUTER_ABI),
    CurvePool: new ethers_1.Interface(exports.CURVE_POOL_ABI),
...
function getRouterInterface(dexName) {
    ...
    if (normalizedName.includes('curve')) {
        return exports.interfaces.CurveRouter;
    }
